/**
 * PROTOTYPE — kopi af DashboardScreen udvidet med alle tabs + prototyper-hub.
 * Må ikke importeres i produktionskode.
 * Når en tab-skærm er godkendt → byg ordentligt i src/screens/
 */
...
import { PrototyperScreen } from './PrototyperScreen';
...
export function PrototypeDashboardScreen() {
  ...
  // Tabs under opbygning
  if (activeTab === 'opgaver' || activeTab === 'timereg' || activeTab === 'kontakt') {
    return (
      <PlaceholderScreen
        tab={activeTab}
        activeTab={activeTab}
  ...
  // Prototyper-hub
  if (activeTab === 'prototyper') {
    return (
      <PrototyperScreen activeTab={activeTab} onTabPress={handleTabPress} />
    );
  }
