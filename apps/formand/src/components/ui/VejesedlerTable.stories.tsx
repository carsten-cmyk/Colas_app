...
/** Statusbar — ét produkt med overskrift + progress */
export const StatusbarEtProdukt: Story = {
  args: {
    vejesedler: INITIAL_VEJESEDLER,
    // TODO: Erstat med Supabase ordre-estimat når klar
    produktEstimater: { '82101H': 250 },
  },
}

/** Statusbar — to produkter, én bar per produkt */
export const StatusbarToProdukt: Story = {
  args: {
    vejesedler: [
      ...INITIAL_VEJESEDLER,
      {
        ...
        ordrenummer: '260423891',
        status: 'udlagt',
        vejeseddelNr: '25-2001-A',
        regnr: 'PQ 11 222',
        chauffoerNavn: 'Anders Bak',
        chauffoerTelefon: '+45 71 12 34 56',
        receptkode: '23001B',
        fabrikId: 'fab-001',
        fabrikNavn: 'PROD A EAST KØGE PH',
        tons: 22.0,
        modtagetTidspunkt: '2026-05-14T11:30:00Z',
        temperatur: 161,
        valgtUdlaeggerMaterielNr: null,
        etaMinutter: null,
        forventetEtaMinutter: null,
    ...
    // TODO: Erstat med Supabase ordre-estimat når klar
    produktEstimater: { '82101H': 250, '23001B': 80 },
  },
}
